...
void Sun::CalculateBillbordMatrix()
{
    ...
    cameraPosMatrix.r[3].m128_f32[0] = cameraPos.x + 0.06; // 足さないと太陽位置がずれる...
    cameraPosMatrix.r[3].m128_f32[1] = cameraPos.y + 0.1; // 足さないと太陽位置がずれる...
    cameraPosMatrix.r[3].m128_f32[2] = cameraPos.z + 0.06; // 足さないと太陽位置がずれる...
