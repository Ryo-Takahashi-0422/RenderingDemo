...
void ColliderGraphicsPipelineSetting::SetInputlayout(int i, D3D12_INPUT_ELEMENT_DESC inputLayout)
{
...
ComPtr<ID3D12PipelineState> ColliderGraphicsPipelineSetting::GetPipelineState()
{
