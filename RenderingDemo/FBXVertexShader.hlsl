...
)
{
    ...
    matrix bm1 = mul(bones[boneno1[0]], ReverceMatrixOfInitialPosture[boneno1[0]]) * boneweight1[0];
    matrix bm2 = mul(bones[boneno1[1]], ReverceMatrixOfInitialPosture[boneno1[1]]) * boneweight1[1];
    matrix bm3 = mul(bones[boneno1[2]], ReverceMatrixOfInitialPosture[boneno1[2]]) * boneweight1[2];
    
    matrix bm4 = mul(bones[boneno2[0]], ReverceMatrixOfInitialPosture[boneno2[0]]) * boneweight2[0];
    matrix bm5 = mul(bones[boneno2[1]], ReverceMatrixOfInitialPosture[boneno2[1]]) * boneweight2[1];
    matrix bm6 = mul(bones[boneno2[2]], ReverceMatrixOfInitialPosture[boneno2[2]]) * boneweight2[2];
